...
public class ComparatorDemo {
    ...
    public void one() {
        ...
        // integerList.sort(comparingInt(e -> {return 1;}));
        integerList.sort(comparingInt(e -> 1));
        System.out.println("list.sort:" + integerList);
    }
    ...
    public void two() {
        ...
        // redirect java.util.List#sort
        // Collections.sort(users, comparingInt(User::getId));
        // System.out.println("two param:" + users);
        
        users.sort(comparingInt(User::getAge));
        System.out.println("list.sort:" + users);
    }
